...
import { DEFAULT_APP_SETTINGS, mergeAppSettings } from '@/shared/lib/appSettings';
import { ACTIVITY_LEVEL_OPTIONS } from '@/shared/constants';
import { buildAppContext, buildHistoryCalendar, buildWeekDayStatus } from '@/shared/lib/dateUtils';
import type {
  ActiveWorkoutDraft,
  AppContext,
  AppSettings,
...
} from '@/core/repositories/supabaseRepository';
import { DEFAULT_ROUTINES, DEFAULT_USER_PROFILE } from '@/core/domain/seedData';
